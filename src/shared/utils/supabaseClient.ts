...
const supabaseBUrl = process.env.NEXT_PUBLIC_SUPABASE_URL ?? "https://qgiichnytbukisofuqiv.supabase.co";
const supabaseBAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? "sb_publishable_kMnEF2aqyz1z2SOB-sxtCQ_s4J-VisB";
