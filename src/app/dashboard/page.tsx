...
// Consolidating Admin 2 Views
import CategoriesShelvesView from "@/components/admin/CategoriesShelvesView";
import PreOrdersView from "@/components/admin/PreOrdersView";
...
export default function AdminPage() {
  ...
  if (loading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-slate-950">
        <p className="text-slate-600 dark:text-slate-400 font-bold text-xs">Loading Unified Super Admin Platform...</p>
      </main>
    );
  }
  ...
  const MENU_ITEMS = [
    ...
    { id: 'pre-orders', label: 'Pre-Orders Hub', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    { id: 'notifications', label: 'Notifications Broadcast', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
